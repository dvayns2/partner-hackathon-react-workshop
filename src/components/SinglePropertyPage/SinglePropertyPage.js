...
class SinglePropertyPage extends Component {
    state = { expanded: false, boostTotal: 0 };

    handleExpandClick = () => {
      this.setState(state => ({ expanded: !state.expanded }));
    };

    calculateBoost = (recommendedChanges) => {
                ...
                <FormControlLabel
                    ...
                    control={
                        <Checkbox
                            ...
                            onChange={this.calculateBoost(recommendedChanges)}
        ...
        return (
            <Card className={classes.card}>
                ...
                <CardContent>
                    ...
                    <Typography paragraph>
                        <em>Total boost opportunity %: {this.state.boostTotal}</em>
                    </Typography>
                </CardContent>
                <CardContent>
                    <Typography variant="h6">
